...
const _combinators_1 = require("./_combinators");
...
class Sequence {
    ...
    take(n) { return this.ctor(_combinators_1.take(this, n)); }
    skip(n) { return this.ctor(_combinators_1.skip(this, n)); }
     ...
     */
    first(predicate) { return _combinators_1.first(this, predicate); }
     ...
     */
    last(predicate) { return _combinators_1.last(this, predicate); }
    filter(predicate) { return this.ctor(_combinators_1.filter(this, predicate)); }
    map(projector) { return new Sequence(_combinators_1.map(this, projector)); }
    reduce(initial, reducer) { return new Sequence(_combinators_1.reduce(this, initial, reducer)); }
    forEach(action) { return _combinators_1.forEach(this, action); }
