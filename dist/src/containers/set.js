...
class Set extends sequence_1.Sequence {
    ...
    some(predicate) { return _combinators_1.some(this, predicate); }
    every(predicate) { return _combinators_1.every(this, predicate); }
    map(projector) { return new Set(_combinators_1.map(this, projector)); }
    union(collections) { return this.ctor(_combinators_1.union([this, ...collections])); }
    intersection(collections) { return this.ctor(_combinators_1.intersection(collections)); }
    except(collections) { return this.ctor(_combinators_1.except(this, collections)); }
    complement(universe) { return _combinators_1.complement([...this], universe); }
