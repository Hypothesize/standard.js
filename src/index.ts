...
// (async () => {
// 	let Array__ = await (await import("./array")).Array__
// 	let String__ = (await import("./string")).String__

// 	let asArray__ = <T>(items: Iterable<T>) => new Array__(items)

// 	let chars = new String__("").getCharacters(asArray__)
// })()


// interface MyConstructor {
// 	readonly [Symbol.species]: MyConstructor;
...
// import { RecursivePartial, Ranker, Predicate, Projector, Reducer, Comparer, Primitive } from './shared'
...
// type Enumerable<T> = Collection.Enumerable<T>
// type Material<T> = Collection.Material<T>
// type MaterialExtended<T> = Collection.MaterialExtended<T>
// type Ordered<T> = Collection.Ordered<T>
// type Indexed<K, V> = Collection.Indexed<K, V>
// type IndexedExtended<K, V> = Collection.IndexedExtended<K, V>
// type _Ranker<T> = Ranker<T>
